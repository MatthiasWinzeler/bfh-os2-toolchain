...
#sudo apt-get -y install ruby rubygems ruby-switch ruby
sudo apt-get -y install ruby rubygems ruby-switch ruby1.9.1-dev ruby1.9.1
#sudo ruby-switch --set ruby1.9.1
#sudo apt-get -y install ruby rubygems ruby-switch ruby1.8
